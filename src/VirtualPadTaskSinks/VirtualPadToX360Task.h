// VirtualPadToX360Task.h

#ifndef _VIRTUAL_PAD_TO_X360_TASK_h
#define _VIRTUAL_PAD_TO_X360_TASK_h
...
/// </summary>
class VirtualPadToX360Task : private Task
{
private:
...
public:
	VirtualPadToX360Task(Scheduler* scheduler, USBXBox360& x360, VirtualPad* virtualPad, const uint32_t updatePeriodMicros)
