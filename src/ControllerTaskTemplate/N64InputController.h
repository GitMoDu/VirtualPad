...
template<
	...
	class N64ControllerTask : public TemplateControllerTask<UpdatePeriodMillis>
{
private:
	...
	using TemplateControllerTask< UpdatePeriodMillis>::Delay;
	using TemplateControllerTask< UpdatePeriodMillis>::Enable;
	using TemplateControllerTask< UpdatePeriodMillis>::OnControllerReadOk;
	using TemplateControllerTask< UpdatePeriodMillis>::OnControllerFail;
...
public:
	N64ControllerTask(Scheduler* scheduler)
		: TemplateControllerTask< UpdatePeriodMillis>(scheduler)
		, Controller(Pin)
	{
